...
extern unsigned long long find_typeset(char *x, TYPELIB *typelib,int *error_position);
...
unsigned long long find_set_from_flags(const TYPELIB *lib, unsigned int default_name,
                              unsigned long long cur_set, unsigned long long default_set,
